...
// To validate positive integer input
int inputIntPositive(void);

// To validate that the entered integer is within a specified range
int inputIntRange(int lowerBound, int upperBound);

// To validate character input
char inputCharOption(char val[]);

// To validate string input
void inputCString(char Cstring[], int n, int max);

// To validate the format for the display of phone number
